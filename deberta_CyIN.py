...
class CyIN_DebertaModel(DebertaV2PreTrainedModel):
    ...
    def __init__(self, config, multimodal_config):
        ...
        cyIN_args = {
            ...
            'cra_layers_la': getattr(multimodal_config, 'cra_layers_la', None),
            'cra_layers_lv': getattr(multimodal_config, 'cra_layers_lv', None),
            'cra_layers_av': getattr(multimodal_config, 'cra_layers_av', None),
